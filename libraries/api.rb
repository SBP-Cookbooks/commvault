  ...
  module Api
    ...
    def _cv_fs_subclient_set_plan_override(endpoint, cv_token, subclient_name, status, filters)
      ...
      if status
        ...
        body = "{ \"subClientProperties\": { \"fsIncludeFilterOperationType\": 3, \"fsExcludeFilterOperationType\": 1, \"fsContentOperationType\": 1, \"useLocalContent\": 1, \"fsSubClientProp\": { \"useGlobalFilters\": 2, \"customSubclientContentFlags\": 0, \"backupSystemState\": 1, \"customSubclientFlag\": 1, \"openvmsBackupDate\": 0, \"includePolicyFilters\": 1 }, \"content\": [ #{tmp.join(',')} ] } }"
      else
